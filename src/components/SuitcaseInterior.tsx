...
const items: {
...
}[] = [
  {
    ...
    position: 'top-[12%] left-[8%] sm:top-[10%] sm:left-[10%]',
    rotation: '-rotate-6',
    size: 'w-[100px] sm:w-[120px] md:w-[140px]',
  ...
  },
  {
    ...
    sublabel: '프로젝트 & 경험',
    Component: ItemBook,
    position: 'top-[10%] right-[8%] sm:top-[8%] sm:right-[10%]',
    rotation: 'rotate-3',
    size: 'w-[110px] sm:w-[130px] md:w-[150px]',
  ...
  },
  {
    ...
    position: 'bottom-[18%] left-[6%] sm:bottom-[15%] sm:left-[8%]',
    rotation: 'rotate-[8deg]',
    size: 'w-[140px] sm:w-[170px] md:w-[200px]',
  ...
  },
  {
    ...
    sublabel: '플레이리스트',
    Component: ItemCD,
    position: 'bottom-[14%] right-[8%] sm:bottom-[12%] sm:right-[12%]',
    rotation: '-rotate-12',
    size: 'w-[100px] sm:w-[120px] md:w-[140px]',
